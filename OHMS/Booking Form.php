...
if(isset($savedata))
{
  ...
  '$room_type','$Occupancy','$cdate','$ctime','$codate','$hotel_name')";
...
<div class="container-fluid text-center"id="primary"><!--Primary Id-->
  ...
  <div class="container">
    <div class="row">
     ...
     <form action="Payment.php" class="form-horizontal" method="post">
       <div class="col-sm-6">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-8">
              <input type="text" class="form-control" readonly="readonly"  value="India" name="city" placeholder="Enter Your City Name"required>
          </div>
        </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
              <div class="row">
                <div class="control-label col-sm-5"><h4>Hotel Name:</h4></div>
                  <div class="col-sm-7">
                ...
                {
                 ?>
                  <option><?php echo $res['hotel_name']; } ?></option>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-7">
                  ...
                  <div class="radio-inline"><input type="radio" value="double" name="Occupancy" required>Dubble</div>
                </div> 
              </div>
            </div>
